...
import com.fsproject.ppmtool.services.ProjectTaskService;
...
public class BacklogController
{
	...
	public ResponseEntity<?> addPTtoBacklog(@Valid @RequestBody ProjectTask projectTask, BindingResult result, @PathVariable String backlog_id, Principal principal)
	{
		...
		ProjectTask projTask = projectTaskService.addProjectTask(backlog_id, projectTask, principal.getName());
